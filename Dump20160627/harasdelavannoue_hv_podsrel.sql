...
--
-- Table structure for table `hv_podsrel`
--

DROP TABLE IF EXISTS `hv_podsrel`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hv_podsrel` (
...
--
-- Dumping data for table `hv_podsrel`
--

LOCK TABLES `hv_podsrel` WRITE;
/*!40000 ALTER TABLE `hv_podsrel` DISABLE KEYS */;
/*!40000 ALTER TABLE `hv_podsrel` ENABLE KEYS */;
UNLOCK TABLES;
